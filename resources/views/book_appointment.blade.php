...
<link rel="alternate" type="application/json+oembed" href="https://www.jotform.com/oembed/?format=json&amp;url=https%3A%2F%2Fform.jotform.com%2F211208945201547" title="oEmbed Form">
<link rel="alternate" type="text/xml+oembed" href="https://www.jotform.com/oembed/?format=xml&amp;url=https%3A%2F%2Fform.jotform.com%2F211208945201547" title="oEmbed Form">
<meta property="og:title" content="Online Doctor Appointment Form" >
<meta property="og:url" content="https://form.jotform.com/211208945201547" >
<meta property="og:description" content="Please click the link to complete this form." >
<meta name="slack-app-id" content="AHNMASS8M">
<link rel="shortcut icon" href="https://cdn.jotfor.ms/favicon.ico">
<link rel="canonical" href="https://form.jotform.com/211208945201547" />
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=2.0, user-scalable=1" />
<meta name="HandheldFriendly" content="true" />
<title>Online Doctor Appointment Form</title>
<link href="https://cdn.jotfor.ms/static/formCss.css?3.3.25227" rel="stylesheet" type="text/css" />
<link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/css/styles/nova.css?3.3.25227" />
<link type="text/css" media="print" rel="stylesheet" href="https://cdn.jotfor.ms/css/printForm.css?3.3.25227" />
<link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/css/styles/payment/payment_feature.css?3.3.25227" />
<!-- <style type="text/css">
...
<script src="https://cdn.jotfor.ms/static/jotform.forms.js?3.3.25227" type="text/javascript"></script>
...
<body style="position:absolute; left:420px">
<form class="jotform-form" action="{{route('store.appointment')}}" method="post" name="form_211208945201547" id="211208945201547" accept-charset="utf-8" autocomplete="on">
  @csrf
  <input type="hidden" name="formID" value="211208945201547" />
    ...
    <ul class="form-section page-section">
      ...
      <li class="form-line jf-required" data-type="control_textbox" id="id_4">
        ...
        <div id="cid_4" class="form-input jf-required">
          <input type="text" id="input_4" name="name" data-type="input-textbox" class="form-textbox validate[required]" size="30" value="" placeholder=" " data-component="textbox" aria-labelledby="label_4" required="" />
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_dropdown" id="id_22">
        ...
        <div id="cid_22" class="form-input jf-required">
          <select class="form-dropdown validate[required]" id="input_22" name="gender" style="width:150px" data-component="dropdown" required="" aria-labelledby="label_22">
        ...
        <div id="cid_23" class="form-input">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top" data-input-type="areaCode">
              <input type="tel" id="input_23_area" name="area_code" class="form-textbox" value="" data-component="areaCode" aria-labelledby="label_23 sublabel_23_area" />
            ...
            <span class="form-sub-label-container" style="vertical-align:top" data-input-type="phone">
              <input type="tel" id="input_23_phone" name="phone_number" class="form-textbox" value="" data-component="phone" aria-labelledby="label_23 sublabel_23_phone" />
        ...
        <div id="cid_20" class="form-input jf-required">
          <div summary="" class="form-address-table jsTest-addressField">
            <div class="form-address-line-wrapper jsTest-address-line-wrapperField">
              <span class="form-address-line form-address-street-line jsTest-address-lineField">
                <span class="form-sub-label-container" style="vertical-align:top">
                  <input type="text" id="input_20_addr_line1" name="patient_address" class="form-textbox validate[required] form-address-line" value="" data-component="address_line_1" aria-labelledby="label_20 sublabel_20_addr_line1" />
                  <label class="form-sub-label" for="patient_address" id="sublabel_20_addr_line1" style="min-height:13px" aria-hidden="false"> Street Address </label>
                </span>
              </span>
            </div>
            ...
            <!-- <span class="form-address-line form-address-country-line jsTest-address-lineField "> -->
                <!-- <span class="form-sub-label-container" style="vertical-align:top"> -->
                  <select class="form-dropdown validate[required] form-address-country noTranslate form-validation-error" name="country" id="input_20_country" data-component="country" required="" aria-labelledby="label_20 sublabel_20_country">
            ...
            <div class="form-address-line-wrapper jsTest-address-line-wrapperField">
              <span class="form-address-line form-address-city-line jsTest-address-lineField ">
                <span class="form-sub-label-container" style="vertical-align:top">
                  <input type="text" id="city" name="city" class="form-textbox validate[required] form-address-city" value="" data-component="city" aria-labelledby="label_20 sublabel_20_city" />
            ...
            <div class="form-address-line-wrapper jsTest-address-line-wrapperField">
              <span class="form-address-line form-address-zip-line jsTest-address-lineField ">
                <span class="form-sub-label-container" style="vertical-align:top">
                  <input type="text" id="input_20_postal" name="zip_code" class="form-textbox form-address-postal" value="" data-component="zip" aria-labelledby="label_20 sublabel_20_postal" />
      ...
      <li class="form-line" data-type="control_email" id="id_24">
        ...
        <div id="cid_24" class="form-input">
          <input type="email" id="input_24" name="email" class="form-textbox validate[Email]" size="30" value="" placeholder="ex: myname@example.com" data-component="email" aria-labelledby="label_24" />
        </div>
      </li>

      <li>
            <b  style="position: relative; left: 40px;">
                <label for="">Doctors</label>
            </b>
      
          <select name="doctor_id" id="" style="position: relative; left: 157px; width: 327px;">
      ...
      <li class="form-line" data-type="control_appointment" id="id_25">
        ...
        <div id="cid_25" class="form-input-wide">
          <div id="input_25" class="appointmentFieldWrapper jfQuestion-fields">
              <input type="date" id="start" name="appointment"> <br><br>
            
            
            <div class="appointmentField">
            <label class="form-label form-label-top" id="label_25" for="input_25"> Time </label>
  ...
  <input type="hidden" class="simple_spc" id="simple_spc" name="simple_spc" value="211208945201547" />
  <script type="text/javascript">
  var all_spc = document.querySelectorAll("form[id='211208945201547'] .si" + "mple" + "_spc");
  for (var i = 0; i < all_spc.length; i++)
  {
    all_spc[i].value = "211208945201547-211208945201547";
  }
  </script>
