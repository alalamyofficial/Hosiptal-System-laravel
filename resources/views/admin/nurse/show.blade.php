		...
		<div class="row">
			<div class="col-md-12">
				...
				@if(count($nurses) > 0)
					<table class="table table-border table-striped custom-table datatable mb-0">
						...
						<tbody>
							...
							<tr>
								...
								<td>{{substr($nurse->start,0,5)}}</td>
								<td>{{substr($nurse->end,0,5)}}</td>
								...
								<td class="text-right">
									<div class="dropdown dropdown-action">
										...
										<form action="{{route('nurse.delete',$nurse->id)}}" method="post">
											@csrf
											@method('delete')
												<a class="dropdown-item" style="width:200px; padding-left:76px;" href="{{route('nurse.edit',$nurse->id)}}"><i class="fa fa-pencil m-r-5"></i> Edit</a>
					...
					<p scope="row" class="text-center"><b>No Nurses Found</b></p>
